...
*
* @file       app/views/admin/dashboard/about.php
...
<aside class="right-side">
    ...
    <section class="content">
        ...
        <h2 class="page-header"><?php echo _ABOUT_LANG_; ?></h2>
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-solid">
                    <div class="box-header">
                        <i class="fa fa-heart"></i>
                        <h3 class="box-title">Sources and Credits :</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                    <p>I've used the following icons, favicon, Charts, Calendar or other files as listed.
        
                    <ul>
                        <li>Thank's to Simple MVC Framework - <a href="http://www.simplemvcframework.com" target="_blank">www.simplemvcframework.com</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-solid">
                    <div class="box-header">
                        ...
                        <h3 class="box-title"><?php echo SITETITLE;?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <p class="lead">Application Folder Structure</p>
