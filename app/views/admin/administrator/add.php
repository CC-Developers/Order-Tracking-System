...
*
* @file       app/views/admin/administrator/add.php
...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo _ADD_NEW_USER_LANG_; ?></li>
        </ol>
    </section>
        ...
        ?>
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><?php echo _FORM_ADD_NEW_USER_LANG_;?></h3> 
                ...
                <div class="box-body">
                    <form enctype="multipart/form-data" role="form" method="post" action="">
                        ...
                        <div class="box-footer">
                            ...
                            <button type='input' name='submit' value='Add' class='btn btn-success'><i class="fa fa-check-square-o"></i> Add New User</button>
