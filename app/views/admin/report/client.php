...
*
* @file       app/views/admin/report/client.php
                    ...
                    <div class="col-xs-12 table-responsive">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $no = 1;
                                            foreach ($data['get_client'] as $row) 
                                            {
                                        ...
                                        <?php } else { ?>
                                            <center><span class='badge bg-red'><?php echo _NO_CLIENT_DATA_LANG_;?></span></center>
                                        <?php } ?>
                            </div><!-- /.box-body -->
