...
*
* @file       app/views/admin/report/task.php
                    ...
                    <div class="col-xs-12 table-responsive">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                            ...
                                            foreach ($data['get_wo_task_project'] as $row) 
                                            {
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <td><b>$row->TaskDesc</b></td>
                                                        <td><b>$row->TaskNotes</b></td>
                                                        <td>
                                                            <center>
                                                                <span class='badge'>$row->TaskProgress %</span>
                                                            </center>
                                                        </td>
                                                        <td>$row->nTaskDate</td>
                                                        <td>$row->nTaskDueDate</td>
                                                    </tr>
                                                ";
                                                $no++;
                                            } 
                                        ...
                                        <?php } else { ?>
                                            <center><span class='badge bg-red'><?php echo _NO_TASK_DATA_LANG_;?></span></center>
                                        <?php } ?>
                            </div><!-- /.box-body -->
