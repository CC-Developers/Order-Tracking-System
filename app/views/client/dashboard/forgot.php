...
*
* @file       app/views/client/dashboard/forgot.php
...
<html class="lockscreen">
    ...
    <body>
        <div class="center">            
            ...
            <div class="lockscreen-name"><?php echo _FORGOT_HEADER_LANG_;?></div>
                ...
                <form action="" method="post">    
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button type="submit" name="submit" value="Recover My Password" class="btn btn-flat"><i class="fa fa-arrow-right text-muted"></i></button>
                        </div>
                    </div>
            ...
            <div class="lockscreen-link">
                <a style="color:#fff;" href='<?php echo DIR;?>login'><?php echo _FORGOT_BACK_LANG_;?></a>
            </div>            
        </div><!-- /.center -->
