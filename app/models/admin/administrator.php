...
*
* @file       app/models/admin/administrator.php
...
/* _COMESTOARRA_LABS_ */
class Administrator extends \core\model {
	...
	public function get_all_user_email() {
		return $this->_db->select("SELECT ".PREFIX."tuser.Email FROM ".PREFIX."tuser WHERE ".PREFIX."tuser.IsActive = 1");
	}
	...
	public function insert_user_data($data){
    		$this->_db->insert(PREFIX.'tuser',$data);
			return $this->_db->lastInsertId('IdUser');
    }
    ...
    public function delete_user_data($data){
		$this->_db->delete(PREFIX.'tuser', $data);
	}
