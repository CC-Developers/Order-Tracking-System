...
class Document {
	...
	static public function getFileType($extension){
	    ...
	    $images = array('jpeg', 'jpg', 'gif', 'png', 'bmp');
	...
	//CLIENT PROFILE PICTURE UPLOAD & GENERATE THUMBNAIL FUNCTIONN 
	public function uploadPhotoClient($fupload_name)
	{
		
		//IMAGE DIRECTORY
		$vdir_upload = "uploads/clients/";
	...
	//USER PROFILE PICTURE UPLOAD & GENERATE THUMBNAIL FUNCTIONN 
	public function uploadPhotoAdmin($fupload_name)
	{
		
		//IMAGE DIRECTORY
		$vdir_upload = "uploads/administrators/";
		$vfile_upload = $vdir_upload . $fupload_name;
	...
	//LOGO PICTURE UPLOAD & GENERATE THUMBNAIL FUNCTIONN 
	public function uploadLogo($fupload_name)
	{
		
		//IMAGE DIRECTORY
		$vdir_upload = "uploads/logo/";
		$vfile_upload = $vdir_upload . $fupload_name;
